<template>
  <div class="comic-shuhuihanhua-list">
...
export default {
  ...
  methods: {
    getAllList () {
      axios.get('http://localhost:31875/static/static-json/comicShuHuiHanHua.json').then(this.getAllListSucc)
    },
    getAllListSucc (res) {
      const data = res.data
      const result = data.result
      if (result) {
        console.log('this is in comics shuhuihanhua' + result)
        this.allList = data.comicShuHuiHanHuaList
      }
    }
  },
  mounted () {
